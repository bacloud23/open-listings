...
export default function (redisDB, log) {
    ...
    const baseQuery = { a: true, d: false }
    const baseProjection = { a: 0.0, d: 0.0, geolocation: 0.0 }
    /** @type { import('mongodb').Sort } */
    const baseSort = ['_id'] //'desc'
    /** @type { import('mongodb').CollationOptions } */
    const baseCollation = { locale: 'simple', normalization: true }
    ...
    this.updateUser = async function (elem) {
        ...
        return dataStores._isMongo
            ...
            : await dataStores[Collections.Users].updateAsync({ _id: elem._id }, { $set: elem }, { multi: false, returnUpdatedDocs: true })
    }
